...
export const tripwireCoreData: MasterFrameworkRecord[] = [
  {
    ...
    cipStandards: "CIP-007-6",
    cipReq: "R5.7",
    reportName: "AD Authentication Failures",
    frequency: "Alert",
    assetScope: "Active Directory Domain Controllers",
    timeScope: "Real-time",
    dataRetention: "90 days",
    goalObjective: "Monitor failed authentication attempts",
    description: "Tripwire monitoring of AD authentication failures",
    details: "",
    outputFormat: "Alert",
    primaryAudience: "Security Team",
  ...
  },
  {
    ...
    cipStandards: "N/A",
    cipReq: "N/A",
    reportName: "AD Group Modifications",
    frequency: "Alert",
    assetScope: "Active Directory Groups",
    timeScope: "Real-time",
    dataRetention: "90 days",
    goalObjective: "Monitor unauthorized group changes",
    description: "Tripwire monitoring of AD group modifications",
    details: "",
    outputFormat: "Alert",
    primaryAudience: "Security Team",
    likelySources: ["Tripwire Enterprise"],
  ...
  },
  {
    ...
    cipStandards: "CIP-007-6", 
    cipReq: "R5.2",
    reportName: "Domain Account Changes",
    frequency: "Daily",
    assetScope: "Domain User Accounts",
    timeScope: "24 hours",
    dataRetention: "90 days",
    goalObjective: "Track domain account modifications",
    description: "Tripwire monitoring of domain account changes",
    details: "",
    outputFormat: "Report",
    primaryAudience: "Security Team",
    likelySources: ["Tripwire Enterprise"],
  ...
  },
  {
    ...
    cipStandards: "CIP-007-6",
    cipReq: "R4.2.2",
    reportName: "AV Service Status",
    frequency: "Alert",
    assetScope: "All managed hosts",
    timeScope: "Real-time",
    dataRetention: "90 days",
    goalObjective: "Monitor antivirus service health",
    description: "Tripwire monitoring of antivirus service status",
    details: "",
    outputFormat: "Alert",
    primaryAudience: "Security Team",
    likelySources: ["Tripwire Enterprise"],
  ...
  },
  {
    ...
    cipStandards: "CIP-007-6",
    cipReq: "R4.1.3",
    reportName: "Malware Detection Events",
    frequency: "Alert",
    assetScope: "All managed hosts",
    timeScope: "Real-time",
    dataRetention: "3 years",
    goalObjective: "Alert on malware detection",
    description: "Tripwire correlation of malware detection events",
    details: "",
    outputFormat: "Alert",
    primaryAudience: "Security Team",
    likelySources: ["Tripwire Enterprise"],
...
export const alertData: MasterFrameworkRecord[] = [
  {
    ...
    cipStandards: "CIP-007-6",
    cipReq: "R5.7",
    reportName: "Critical AD Access Alert",
    frequency: "Alert",
    assetScope: "Critical AD Infrastructure",
    timeScope: "Immediate",
    dataRetention: "90 days",
    goalObjective: "Immediate notification of critical access events",
    description: "High-priority alert for critical AD access events",
    details: "",
  ...
  },
  {
    ...
    cipStandards: "N/A",
    cipReq: "N/A", 
    reportName: "Privileged Group Change Alert",
    frequency: "Alert",
    assetScope: "Privileged AD Groups",
    timeScope: "Immediate",
    dataRetention: "90 days",
    goalObjective: "Immediate notification of privileged group changes",
    description: "High-priority alert for privileged group modifications",
    details: "",
    outputFormat: "Email/SMS Alert",
    primaryAudience: "SOC Team",
    likelySources: ["SIEM"],
  ...
  },
  {
    ...
    cipStandards: "CIP-007-6",
    cipReq: "R4.2.2",
    reportName: "AV Service Down Alert",
    frequency: "Alert",
    assetScope: "Critical hosts",
    timeScope: "Immediate",
    dataRetention: "90 days",
    goalObjective: "Immediate notification of AV service failures",
    description: "Critical alert when antivirus services fail",
    details: "",
    outputFormat: "Email/SMS Alert",
    primaryAudience: "SOC Team",
    likelySources: ["SIEM"],
  ...
  },
  {
    ...
    cipStandards: "CIP-007-6",
    cipReq: "R4.1.3",
    reportName: "Malware Detected Alert",
    frequency: "Alert",
    assetScope: "All hosts",
    timeScope: "Immediate",
    dataRetention: "3 years",
    goalObjective: "Immediate notification of malware detection",
    description: "Critical alert when malware is detected",
    details: "",
    outputFormat: "Email/SMS Alert",
    primaryAudience: "SOC Team",
    likelySources: ["SIEM"],
